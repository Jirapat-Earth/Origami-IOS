...
import 'package:origami_ios/need/widget_mini/mini_asset.dart';
import 'package:origami_ios/need/widget_mini/mini_contact.dart';
import 'package:origami_ios/need/widget_mini/mini_department.dart';
import 'package:origami_ios/need/widget_mini/mini_division.dart';
import 'package:origami_ios/need/widget_mini/mini_employee.dart';
import 'package:origami_ios/need/widget_mini/mini_item.dart';
...
class _NeedDetailState extends State<NeedDetail> {
                                            ...
                                            (indexI) {
                                              return Padding(
                                                ...
                                                child: InkWell(
                                                      ...
                                                      : (saveItemList[index]
                                                          ...
                                                          : Container(
                                                              ...
                                                              child: ClipRRect(
                                                                ...
                                                                child: Image
                                                                    .network(
                                                                  'https://www.origami.life//images/ogm_logo.png?v=1723543870265',
                                                                  height: 120,
                                                                  width: 120,
                                                                  fit: BoxFit
                                                                      .cover,
                                                  ...
                                                  //                         10),
                                                  //           ),
                                                  //   child: Image.network('https://www.origami.life//images/ogm_logo.png?v=1723543870265',s),
                                                  // ),
                                                ),
                                              );
                                            },
  ...
  Future<void> fetchDeleteItem(item_sort) async {
    final uri =
        Uri.parse('https://www.origami.life/api/origami/need/delete-item.php');
    try {
      final response = await http.post(
        uri,
        body: {
